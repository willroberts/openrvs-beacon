...
const (
	...
	pilcrow      = '¶'       // Red Storm used this as a field separator.
...
// NOTE: Return []byte instead of string to preserve Extended ASCII values. Unicode conversion can
// prevent the parser from detecting the pilcrow sign (ASCII 182).
